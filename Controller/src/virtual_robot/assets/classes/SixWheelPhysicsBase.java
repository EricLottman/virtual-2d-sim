package virtual_robot.assets.classes;
...
/**
 * For internal use only. Abstract base class for a physics-based six wheel robot.
 */
public class SixWheelPhysicsBase extends VirtualBot {
    ...
    protected double interWheelDistance;
...
//        assert (frontMotor.getDirection() == backMotor.getDirection());
    ...
    public synchronized void updateStateAndSensors(double millis) {
         ...
         */
        leftMotorFront.update(millis);
        leftMotorBack.update(millis);
        rightMotorFront.update(millis);
    ...
    public void powerDownAndReset() {
        leftMotorFront.stopAndReset();
        leftMotorBack.stopAndReset();
        rightMotorFront.stopAndReset();
        rightMotorBack.stopAndReset();
        imu.close();
